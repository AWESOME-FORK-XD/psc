...
function permit_masuk() {
	...
	BURIQ() {
		curl -sS https://raw.githubusercontent.com/majrot/kuprit/main/ip.txt > /root/tmp
	...
	Name=$(curl -sS https://raw.githubusercontent.com/majrot/kuprit/main/ip.txt | grep $MYIP | awk '{print $2}')
